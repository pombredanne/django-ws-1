...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.celery_task'
        db.add_column('ws_node', 'celery_task',
                      self.gf('ws.fields.CeleryTaskField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.celery_task'
        db.delete_column('ws_node', 'celery_task')
