...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Process.priority'
        db.alter_column('ws_process', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Adding field 'Task.info_required'
        db.add_column('ws_task', 'info_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Task.priority'
        db.alter_column('ws_task', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Process.priority'
        db.alter_column('ws_process', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
        # Deleting field 'Task.info_required'
        db.delete_column('ws_task', 'info_required')


        # Changing field 'Task.priority'
        db.alter_column('ws_task', 'priority', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        'ws.node': {
            ...
            'celery_task': ('ws.fields.CeleryTaskField', [], {'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ws.process': {
            ...
            'params': ('jsonfield.fields.JSONField', [], {'default': '{}', 'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'subprocesses'", 'null': 'True', 'to': "orm['ws.Task']"}),
            'priority': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '9'}),
