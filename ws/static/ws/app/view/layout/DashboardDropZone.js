/*
This file is based on PortalDropZone.js from Ext JS 4
*/
Ext.define('WS.view.layout.DashboardDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(dashboard, cfg) {
        this.dashboard = dashboard;
        Ext.dd.ScrollManager.register(dashboard.body);
        WS.view.layout.DashboardDropZone.superclass.constructor.call(this, dashboard.body, cfg);
    ...
    unreg: function() {
        ...
        WS.view.layout.DashboardDropZone.superclass.unreg.call(this);
    }
});
